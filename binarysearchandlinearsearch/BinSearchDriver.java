...
public class BinSearchDriver {
	...
	public final static String FILE_AND_PATH = "C:\\Users\\Christopher\\Desktop\\CSS162Real\\Homework6\\src\\hw6\\longwords.txt";
	/* 
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		//tryLinearSearch(wordsToSearch, "sinon"); //uses check.txt
		//tryLinearSearch(wordsToSearch, "math"); //uses check.txt
		//tryLinearSearch(wordsToSearch, "ABBREVIATES");//check for recursion on large text file
	...
	SearchAlgorithm bs2 = new BinarySearch();
	
	try {
		System.out.print( target + " found at index: " + bs2.recSearch(wordsToSearch,target));
		System.out.println( " taking " + bs2.getCount() + " comparisons.");
	} 
	catch( ItemNotFoundException e ) {
		System.out.println( target + ":" + e.getMessage());
	}	
	...
	/*SearchAlgorithm bs2 = new LinearSearch();
